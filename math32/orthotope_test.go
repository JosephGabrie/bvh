...
func TestOverlaps(t *testing.T) {
	o1 := &Orthotope{Point: Coordinate{10, -20}, Delta: Coordinate{30, 30}}
	o2 := &Orthotope{Point: Coordinate{-10, 5}, Delta: Coordinate{30, 30}}
	o3 := &Orthotope{Point: Coordinate{-10, 25}, Delta: Coordinate{30, 30}}
...
func TestContains(t *testing.T) {
	o1 := &Orthotope{Point: Coordinate{10, -20}, Delta: Coordinate{30, 30}}
	o2 := &Orthotope{Point: Coordinate{15, -20}, Delta: Coordinate{20, 20}}
	o3 := &Orthotope{Point: Coordinate{-10, 5}, Delta: Coordinate{30, 30}}
...
func TestScore(t *testing.T) {
	o := &Orthotope{Point: Coordinate{10, -20}, Delta: Coordinate{30, 15}}
...
func TestIntersects(t *testing.T) {
	o := &Orthotope{Point: Coordinate{-10, 0}, Delta: Coordinate{10, 10}}
	delta := &Coordinate{20, -20}

	o1 := &Orthotope{Point: Coordinate{-10, -25}, Delta: Coordinate{10, 10}}
	...
	o2 := &Orthotope{Point: Coordinate{15, -25}, Delta: Coordinate{10, 10}}
	...
	o3 := &Orthotope{Point: Coordinate{10, -5}, Delta: Coordinate{10, 10}}
...
func TestMinBounds(t *testing.T) {
	...
	o1.MinBounds(o2, o3)
	expected := &Orthotope{Point: Coordinate{-10, -20}, Delta: Coordinate{45, 55}}
...
func TestOrthEquals(t *testing.T) {
	o1 := &Orthotope{Point: Coordinate{10, -20}, Delta: Coordinate{30, 30}}
	o2 := &Orthotope{Point: Coordinate{10, -20}, Delta: Coordinate{30, 30}}
	o3 := &Orthotope{Point: Coordinate{10, -5}, Delta: Coordinate{30, 20}}
	o4 := &Orthotope{Point: Coordinate{10, -5}, Delta: Coordinate{30, 25}}
